...
class BlankFragment : BaseFragment<FragmentBlankBinding>(FragmentBlankBinding::inflate) {
    ...
    private fun formatBytes(bytes: Long): String {
        ...
        val kb = bytes / 1024.0
        if (kb < 1024.0) return String.Companion.format(Locale.US, "%.1f KB", kb)

        val mb = kb / 1024.0
        if (mb < 1024.0) return String.Companion.format(Locale.US, "%.1f MB", mb)

        return String.Companion.format(Locale.US, "%.1f GB", mb / 1024.0)
    }
    ...
    private fun currentLogTime(): String {
        return String.Companion.format(Locale.US, "%tT", System.currentTimeMillis())
    }
